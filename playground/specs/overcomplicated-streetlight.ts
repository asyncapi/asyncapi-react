export const overcomplicatedStreetlights = `asyncapi: '2.6.0'
...
components:
  ...
  schemas:
    lightMeasuredPayload:
      ...
      properties:
        ...
        location:
          type: string
          pattern: "^[A-Z]{2}-[0-9]{5}$"  # This will match patterns like "NY-12345"
          description: Location code for the streetlight following format XX-12345
        ifElseThen:
          type: integer
          minimum: 1
          maximum: 1000
  ...
  parameters:
    ...
    Location:
      description: The physical location coordinates of the streetlight
      schema:
        type: object
        properties:
          latitude:
