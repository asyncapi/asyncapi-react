// Gemini market data: a public WebSocket API (wss://api.gemini.com), so the WebSocket plugin
// has a real server to connect to in the playground. Copied from the library test fixture at
// library/src/__tests__/docs/v3/websocket-gemini.json.
export const websocketGemini = `{
  "asyncapi": "3.0.0",
  "info": {
