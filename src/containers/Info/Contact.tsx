    ...
    return (
      <ContactWrapper>
        ...
        <ContactList>
          ...
          {url && <li><strong>Url</strong>: <HrefHeader href={url} target="_blank">{url}</HrefHeader></li>}
          {email && <li><strong>Email</strong>: <HrefHeader href={`mailto:${email}`}>{email}</HrefHeader></li>}
        </ContactList>
      </ContactWrapper>
    );
  }
