...
//     const oneOf: boolean =
//       (topic.publish && (topic.publish as any).oneOf) ||
//       ((topic.subscribe && (topic.subscribe as any).oneOf) as boolean);
...
//       return (
//         <TopicMessage>
//           <MessageComponent message={publish as Message} />
//         </TopicMessage>
//       );
//     } else {
...
//       return (
//         <TopicMessage>
//           <MessageComponent message={subscribe as Message} />
//         </TopicMessage>
//       );
//     } else {
