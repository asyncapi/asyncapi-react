  ...
  operationTraits:
    kafka:
      bindings:
        kafka:
          clientId: my-app-id
`;class tH extends d.Component{constructor(e){super(e),this.state={schema:tW,config:t$,schemaFromExternalResource:"",refreshing:!1},this.updateSchema=e=>{this.setState({schema:e})},this.updateSchemaFromExternalResource=e=>{this.setState({schemaFromExternalResource:e})},this.updateConfig=e=>{this.setState({config:e})},this.startRefreshing=()=>{setTimeout(()=>{this.setState({refreshing:!0})},500)},this.stopRefreshing=()=>{this.setState({refreshing:!1})},this.updateSchemaFn=tM(this.updateSchema,750,this.startRefreshing,this.stopRefreshing),this.updateConfigFn=tM(this.updateConfig,750,this.startRefreshing,this.stopRefreshing)}render(){let{schema:e,config:t,schemaFromExternalResource:n}=this.state,r=(e=>{if(!e)return{};try{return JSON.parse(e)}catch(e){return{}}})(t||t$);return(0,u.jsxs)(tc,{children:[(0,u.jsx)(tI,{}),(0,u.jsxs)(tU,{children:[(0,u.jsx)(tg,{children:(0,u.jsxs)(tz,{additionalHeaderContent:(0,u.jsx)(tN,{$show:this.state.refreshing,children:""}),children:[(0,u.jsx)(t_,{title:"Schema",children:(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(tq,{parentCallback:this.updateSchemaFromExternalResource}),(0,u.jsx)(tR,{code:e,externalResource:n,parentCallback:this.updateSchemaFn},"Schema")]})},"Schema"),(0,u.jsx)(t_,{title:"Configuration",children:(0,u.jsx)(tR,{code:t,parentCallback:this.updateConfigFn},"Configuration")},"Configuration")]})}),(0,u.jsx)(tv,{children:(0,u.jsx)(to,{schema:e,config:r})})]})]})}}let tV=tH},48608:()=>{},87899:()=>{},96172:()=>{}},e=>{e.O(0,[61,929,163,248,450,391,965,93,347,158,358],()=>e(e.s=37376)),_N_E=e.O()}]);